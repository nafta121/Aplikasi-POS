    ...
    <div className="space-y-6 pb-12">
      ...
      {activeTab === 'stok' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          ...
          {/* TABEL DATA STOK GUDANG: Dibungkus overflow-x-auto w-full dengan responsive padding */}
          <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 overflow-hidden shadow-xs w-full">
            <div className="overflow-x-auto w-full">
              <table className="w-full text-left text-xs sm:text-sm md:text-base border-collapse min-w-[760px]">
                <thead>
                  <tr className="text-[10px] sm:text-[11px] md:text-xs uppercase tracking-wider bg-slate-100/80 dark:bg-slate-800/80 text-slate-600 dark:text-slate-400 border-b border-slate-200 dark:border-slate-800 font-bold">
                    <th className="p-2.5 sm:p-3 md:p-4 font-bold">SKU &amp; Barcode</th>
                    <th className="p-2.5 sm:p-3 md:p-4 font-bold">Nama Material &amp; Satuan</th>
                    <th className="p-2.5 sm:p-3 md:p-4 text-right font-bold">
                      <span className="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400">
                        <Lock className="h-3 w-3" />
                        HPP Beli (Admin)
                      </span>
                    </th>
                    <th className="p-2.5 sm:p-3 md:p-4 text-center font-bold">Stok Global</th>
                    <th className="p-2.5 sm:p-3 md:p-4 text-center font-bold bg-amber-500/5 dark:bg-amber-500/10 border-x border-slate-200/70 dark:border-slate-800">
                      Toko Utama (Display)
                    </th>
                    <th className="p-2.5 sm:p-3 md:p-4 text-center font-bold">Gudang 01 (Logistik)</th>
                    <th className="p-2.5 sm:p-3 md:p-4 text-center font-bold">Aksi CRUD</th>
                  </tr>
                </thead>
                  ...
                  {isLoadingInventory ? (
                    ...
                    filteredInventory.map((item) => {
                      ...
                      return (
                        ...
                        >
                          {/* 1. KOLOM SKU & BARCODE */}
                          <td className="p-2.5 sm:p-3 md:p-4 whitespace-nowrap">
                          ...
                          <td className="p-2.5 sm:p-3 md:p-4 text-right whitespace-nowrap font-mono">
                          ...
                          {/* 4. KOLOM STOK GLOBAL */}
                          <td className="p-2.5 sm:p-3 md:p-4 text-center whitespace-nowrap font-mono">
                          ...
                          {/* 5. KOLOM TOKO UTAMA */}
                          <td className="p-2.5 sm:p-3 md:p-4 text-center whitespace-nowrap bg-amber-500/5 dark:bg-amber-500/10 border-x border-slate-200/70 dark:border-slate-800">
                            {isStockTokoCritical ? (
                          ...
                          <td className="p-2.5 sm:p-3 md:p-4 text-center whitespace-nowrap">
      ...
      {activeTab === 'surat-jalan' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          ...
          {/* KANBAN BOARD 3 KOLOM STATUS PENGIRIMAN: Mobile bersusun (flex-col), Desktop bersebelahan (lg:flex-row) */}
          <div className="flex flex-col lg:flex-row gap-4 items-start w-full">
            {/* ==================================================== */}
            {/* KOLOM A: [Menunggu Disiapkan] (Faktur baru kasir)    */}
            {/* ==================================================== */}
            <div className="w-full flex-1 min-w-0 p-4 rounded-3xl bg-slate-100/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 space-y-3">
      ...
      {isTransferModalOpen && selectedItemForTransfer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="w-[95%] sm:w-[90%] md:max-w-lg bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 shadow-2xl space-y-5 animate-in zoom-in-95 duration-200 max-h-[85vh] overflow-y-auto">
            {/* Modal Header */}
      ...
      {selectedDOForPreview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="w-[95%] sm:w-[90%] md:max-w-xl bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-4 sm:p-6 shadow-2xl space-y-4 animate-in zoom-in-95 duration-200 max-h-[85vh] overflow-y-auto">
